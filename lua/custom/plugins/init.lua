...
return {
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<C-n>', nav(1), { desc = '<Harpoon>navigates to file 1' })
      vim.keymap.set('n', '<C-m>', nav(2), { desc = '<Harpoon>navigates to file 2' })
      vim.keymap.set('n', '<C-,>', nav(3), { desc = '<Harpoon>navigates to file 3' })
      vim.keymap.set('n', '<C-.>', nav(4), { desc = '<Harpoon>navigates to file 4' })
      vim.keymap.set('n', '<C-/>', nav(5), { desc = '<Harpoon>navigates to file 5' })
    end,
  },
}
